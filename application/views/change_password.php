    ...
    <div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
        <div class="page-content">
            ...
            <div class="page-login-main animation-slide-right animation-duration-1">
                ...
                <h3 class="font-size-24">Ganti Password</h3>
                <?= $this->session->flashdata('message'); ?>
                <h5 class="text-primary"><?= $this->session->userdata('reset_email'); ?></h5>
                <form method="post" action="<?= base_url('auth/changepassword') ?>">
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" style="display: none">
                    <div class="form-group">
                        <input type="password" name="password1" id="password1" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Masukkan password baru...">
                        <?= form_error(
                            'password1',
                    ...
                    <div class="form-group">
                        <input type="password" name="password2" id="password2" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Masukkan ulang password...">
                        <?= form_error(
                            'password2',
                            '<small class="text-danger pl-3">',
                            '</small>'
